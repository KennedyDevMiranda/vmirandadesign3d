...
import { Camera, Palette, Layers, Mail, Instagram, Youtube, Github, Sparkles, Badge as BadgeIcon } from "lucide-react";
    ...
    <main className="min-h-screen bg-neutral-950 text-white">
      ...
      <section id="contato" className="max-w-7xl mx-auto px-6 py-16">
        <div className="rounded-3xl border border-white/10 bg-gradient-to-tr from-white/10 to-white/[0.02] p-8 md:p-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <a href="mailto:contato@vmiranda3d.com" className="rounded-xl bg-white text-black px-5 py-3 text-sm font-semibold hover:bg-white/90 transition inline-flex items-center gap-2"><Mail className="w-4 h-4"/> contato@vmiranda3d.com</a>
        </div>
      </section>
